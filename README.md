...
```
cd existing_repo
git remote add origin https://gitlab.com/japromis/docker-difft.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.com/japromis/docker-difft/-/settings/integrations)
